<template>
  <v-app>
    ...
    >
      <div class="boxed-container w-full">
        <div class="d-flex align-center mx-6">
          ...
          <app-bar-user-menu @clickAlterarSenha="onClickAlterarSenha" />
        </div>
      </div>
    </v-app-bar>
    ...
    <ModalSenha
      ...
      @fechar="fecharModalAlterarSenha"
    />
  </v-app>
</template>
...
import ModalSenha from "../components/ModalSenha/ModalSenha.vue";
...
export default {
  ...
  methods: {
    ...
    fecharModalAlterarSenha() {
      ...
      console.log(this.showModalAlterarSenha);
    }
  },
};
</script>
